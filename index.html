...
<body>
    <header><h1><g>O'Clock</g></h1></header>

<div id = "container1">
    <h1>Horloge</h1>
        <div id = "clock"></div>
    <h2>Alarme</h2>
        <div><input id ="alarm" name = "alarmTime" type ="datetime-local"></div>
        <div><input id ="message" type ="text" placeholder ="Message..."></div>
        <button id ="aSet">Set</button>
        <button id ="aClear">Clear</button>
        <button><a href="index.html" style="color:white;text-decoration:none;">Reset</a></button>
</div>
    <div id ="alarmC">
        <div id ="alarming"></div>
    </div>
